    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price_discount', models.PositiveBigIntegerField(blank=True, null=True, verbose_name='قیمت با تخفیف')),
                ...
                ('categories', models.ManyToManyField(to='book.CategoryModel', verbose_name='گروه')),
            ],
            options={
                'verbose_name': 'کتاب',
